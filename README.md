...
This repository provides a **Multi-Type-Road-Surface-Dataset** for road surface recognition tasks based on PyTorch. The dataset is designed to support supervised classification of different road surface types under varying illumination conditions.
